...
def main(args):
    ...
    print("Runs", len(runs_to_process))
    downloaded_nb = 0    
    runs_to_print = []
    runs_to_download = []
    ...
    print("Runs", len(runs_to_download))
    if args.idx != -1:
        runs_to_download = [runs_to_download[args.idx]]
    print("Runs to download", runs_to_download)
...
if __name__ == "__main__":
    ...
    ap.add_argument('-i', '--idx', type = int,  default = -1, help = 'Select only the idx-th run')
    args = ap.parse_args()
